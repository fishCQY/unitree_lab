...
UNITREE_G1_PR_CFG = ArticulationCfg(
    ...
    init_state=ArticulationCfg.InitialStateCfg(
        ...
        joint_pos={
            ...
            "left_ankle_A_joint": 0.52,
            "left_ankle_B_joint": -0.52,
            "right_ankle_A_joint": -0.52,
            "right_ankle_B_joint": 0.52,
        },
        joint_vel={".*": 0.0},
    ),
    ...
    actuators={
        "legs": DelayedImplicitActuatorCfg(
            ...
            effort_limit_sim={
                ...
                ".*_constraint_[L,R]_joint": MotorParameter["5020"]["effort_limit"],
            },
            velocity_limit_sim={
                ...
                ".*_constraint_[L,R]_joint": MotorParameter["5020"]["velocity_limit"],
            },
            stiffness={
            ...
            armature={
                ...
                "waist_pitch_joint": MotorParameter["5020"]["armature"],
                "waist_roll_joint": MotorParameter["5020"]["armature"],
                ".*_constraint_[L,R]_joint": MotorParameter["5020"]["armature"],
            },
            friction={
                ...
                ".*_constraint_[L,R]_joint": MotorParameter["5020"]["friction"],
            },
            min_delay=MIN_DELAY,
            max_delay=MAX_DELAY,
        ),
        "feet": DelayedImplicitActuatorCfg(
            joint_names_expr=[".*_ankle_pitch_joint", ".*_ankle_roll_joint",
                              ".*_ankle_A_joint", ".*_ankle_B_joint"],
            effort_limit_sim={
                ".*_ankle_pitch_joint": 2 * MotorParameter["5020"]["effort_limit"],
                ".*_ankle_roll_joint": 2 * MotorParameter["5020"]["effort_limit"],
                ".*_ankle_A_joint": MotorParameter["5020"]["effort_limit"],
                ".*_ankle_B_joint": MotorParameter["5020"]["effort_limit"],
            },
            velocity_limit_sim={
                ".*_ankle_pitch_joint": MotorParameter["5020"]["velocity_limit"],
                ".*_ankle_roll_joint": MotorParameter["5020"]["velocity_limit"],
                ".*_ankle_A_joint": MotorParameter["5020"]["velocity_limit"],
                ".*_ankle_B_joint": MotorParameter["5020"]["velocity_limit"],
            },
            stiffness={
                ".*_ankle_pitch_joint": 2 * MotorParameter["5020"]["computed_stiffness"],
                ".*_ankle_roll_joint": 2 * MotorParameter["5020"]["computed_stiffness"],
                ".*_ankle_A_joint": 0.0,
                ".*_ankle_B_joint": 0.0,
            },
            damping={
                ".*_ankle_pitch_joint": 2 * MotorParameter["5020"]["computed_damping"],
                ".*_ankle_roll_joint": 2 * MotorParameter["5020"]["computed_damping"],
                ".*_ankle_A_joint": 0.0,
                ".*_ankle_B_joint": 0.0,
            },
            armature={
                ".*_ankle_pitch_joint": MotorParameter["5020"]["armature"],
                ".*_ankle_roll_joint": MotorParameter["5020"]["armature"],
                ".*_ankle_A_joint": MotorParameter["5020"]["armature"],
                ".*_ankle_B_joint": MotorParameter["5020"]["armature"],
            },
            friction={
                ".*_ankle_pitch_joint": 0.0,
                ".*_ankle_roll_joint": 0.0,
                ".*_ankle_A_joint": MotorParameter["5020"]["friction"],
                ".*_ankle_B_joint": MotorParameter["5020"]["friction"],
            },
            min_delay=MIN_DELAY,
            max_delay=MAX_DELAY,
        ),
...
# Joints to exclude from action scaling
EXCLUDED_PR_JOINTS = {
    ".*_ankle_A_joint",
    ".*_ankle_B_joint",
    ".*_constraint_[L,R]_joint",
}

for actuator_name, actuator_cfg in UNITREE_G1_PR_CFG.actuators.items():
    ...
    for pattern in joint_names:
        ...
        for key in effort_limit.keys():
            # Skip excluded joints
            if key in EXCLUDED_PR_JOINTS:
                continue

            if key == pattern or key in stiffness:
                stiffness_val = stiffness.get(key)
                effort_val = effort_limit.get(key)
                if stiffness_val is not None and effort_val is not None and stiffness_val > 0:
                    scale = SCALE_FACTOR * effort_val / stiffness_val
                    G1_PR_ACTION_SCALE[key] = scale

# If no action scales were calculated (shouldn't happen), use default
if not G1_PR_ACTION_SCALE:
    print("[WARNING] No action scales calculated, using default value")
    G1_PR_ACTION_SCALE = 0.25  # Fallback to scalar value



UNITREE_G1_AB_CFG = ArticulationCfg(
    spawn=sim_utils.UsdFileCfg(
        usd_path=f"{ISAAC_ASSET_DIR}/Robots/Unitree/g1_29dof_rev_1_0.usd",
        activate_contact_sensors=True,
        rigid_props=sim_utils.RigidBodyPropertiesCfg(
            disable_gravity=False,
            retain_accelerations=False,
    ...
    actuators={
        "legs": DelayedImplicitActuatorCfg(
            ...
            stiffness={
                ...
                "waist_pitch_joint": 0.0,
                "waist_roll_joint": 0.0,
                ".*_constraint_[L,R]_joint": MotorParameter["5020"]["computed_stiffness"],
            },
            damping={
                ".*_hip_yaw_joint": MotorParameter["7520_16"]["computed_damping"],
                ".*_hip_roll_joint": MotorParameter["7520_22"]["computed_damping"],
                ...
                "waist_pitch_joint": 0.0,
                "waist_roll_joint": 0.0,
                ".*_constraint_[L,R]_joint": MotorParameter["5020"]["computed_damping"],
            },
            armature={
                ".*_hip_yaw_joint": MotorParameter["7520_16"]["armature"],
                ".*_hip_roll_joint": MotorParameter["7520_22"]["armature"],
        ...
        "feet": DelayedImplicitActuatorCfg(
            ...
            stiffness={
                ".*_ankle_pitch_joint": 0.0,
                ".*_ankle_roll_joint": 0.0,
                ".*_ankle_A_joint": MotorParameter["5020"]["computed_stiffness"],
                ".*_ankle_B_joint": MotorParameter["5020"]["computed_stiffness"],
            },
            damping={
                ".*_ankle_pitch_joint": 0.0,
                ".*_ankle_roll_joint": 0.0,
                ".*_ankle_A_joint": MotorParameter["5020"]["computed_damping"],
                ".*_ankle_B_joint": MotorParameter["5020"]["computed_damping"],
            },
            armature={
                ".*_ankle_pitch_joint": MotorParameter["5020"]["armature"],
                ".*_ankle_roll_joint": MotorParameter["5020"]["armature"],
...
for actuator_name, actuator_cfg in UNITREE_G1_AB_CFG.actuators.items():
    effort_limit = actuator_cfg.effort_limit_sim
    stiffness = actuator_cfg.stiffness
    joint_names = actuator_cfg.joint_names_expr
    ...
    for pattern in joint_names:
        ...
        for key in effort_limit.keys():
            ...
            if key == pattern or key in stiffness:
                ...
                if stiffness_val is not None and effort_val is not None and stiffness_val > 0:
                    scale = SCALE_FACTOR * effort_val / stiffness_val
                    G1_AB_ACTION_SCALE[key] = scale

# If no action scales were calculated (shouldn't happen), use default
if not G1_AB_ACTION_SCALE:
    print("[WARNING] No action scales calculated, using default value")
    G1_AB_ACTION_SCALE = 0.25  # Fallback to scalar value